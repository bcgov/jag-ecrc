class OrgVerificationPage {
  constructor() {
    ...
    this.learMoreAboutBCServicesCard = element(
      by.xpath(
        "//a[@href='https://www2.gov.bc.ca/gov/content/governments/government-id/bc-services-card']"
      )
    );
    this.learnMoreAboutBCServicesCardEligibility = element(
      by.xpath(
    ...
    this.bcServiceCardWebsite = element(
      by.xpath(
    ...
    this.electronicIdentityVerification = element(
      by.xpath(
        "//a[@href='https://www2.gov.bc.ca/gov/content/safety/crime-prevention/criminal-record-check/electronic-identity-verification-eiv']"
      )
    );
    this.resultsAndConsideration = element(
      by.xpath(
        "//a[@href='https://www2.gov.bc.ca/gov/content/safety/crime-prevention/criminal-record-check/results-and-reconsiderations']"
      )
    );
  }
}
