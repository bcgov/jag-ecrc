...
public class EcrcJWTValidationServiceImplTest {
	...
	@Test
	public void testAccessToken() throws JsonProcessingException, EcrcServiceException {
		...
		String accessToken = TestTokenGenerator.generateBCSCAccessToken(privateKey, ecrcProperties.getOauthIdp() + "/oauth2/", exp.getTime());
	...
	@Test
	public void testAccessTokenExpired() throws JsonProcessingException, EcrcServiceException {
		MockResponse mockResponse = new MockResponse();
		mockResponse.setBody(jwksResponse);
		mockResponse.addHeader("content-type: application/json;charset=ISO-8859-1");
		mockResponse.setResponseCode(200);
